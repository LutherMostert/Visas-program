# Board opening — framing notes

Aim: land the forward book **before** the action-plan discussion, so re-baselined numbers reflect the new revenue, not just the legacy hole. Target 6–8 minutes for the opening, then hand back to Antoine's agenda.

## The framing line

> "Antoine's agenda covers three vessels in dry-dock. Before we get into the action plan, I want to put two more contracts on the board's chart — because the right conclusion about provisioning and action depends on the whole picture, not half of it."

## The opening — structure

**1. Forward book (2–3 minutes).** Lead with this. Not defensive, not apologetic.
- SIPIM: 8–12 months locked. `[N$ ... annualised]`. Ramp starts `[date]`. Operational implications: `[headcount / opex]`.
- D9: reactivation confirmed. Technical scope: `[summary]`. Daron coverage tier: `[tier]`. Annualised: `[N$ ...]`.
...
Short answer, no defensiveness:
- Cession was the mitigant; we believed — and still believe — it was the right structure
- The escalation path was triggered at month `[N]` of non-payment
- WKH was engaged at month `[N]`
- What's changed is Mabasen's posture, not our monitoring
